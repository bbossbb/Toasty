...
<head>
    ...
    <title>Toasty | Staff Payment</title><link href="https://fonts.googleapis.com/css?family=Cormorant+Garamond:300i,400,400i,500,500i,600,600i,700&amp;display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <header class="header header--default" data-sticky="true">
      ...
      <div class="header__center">
        ...
        <nav class="header__navigation right">
          <ul class="menu">
            <li class="current-menu-item menu-item-has-children"><a href="productstock.php">Product Stock Check</a><span class="sub-toggle"><i class="fa fa-angle-down"></i></span>
    ...
    <?php 
				 	...
				 	$q= "SELECT DISTINCT o.paymentid as paymentid1,o.totalprice as totalprice, payment.paymenttypeid as paymenttypeid,o.paymentstatus as paymentstatus  FROM `order` as o,`payment` WHERE o.paymentid = payment.paymentid";
					$result=$con->query($q);
					if(!$result){
...
<tr>
                    <td><?php echo $rows['paymentid1'] ?></td>
                    <td><?php echo $rows['totalprice'] ?></td>
                    <td><?php echo $rows['paymenttypeid'] ?></td>
                    <td><?php echo $rows['paymentstatus'] ?></td>
                    <td><a href='payment_edit.php?paymentid=<?=$rows['paymentid1']?>'><img src="img/edit-button.png" width="24" height="24"></a></td>
