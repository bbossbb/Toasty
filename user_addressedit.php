...
<head>
    ...
    <title>Toasty | Address</title><link href="https://fonts.googleapis.com/css?family=Cormorant+Garamond:300i,400,400i,500,500i,600,600i,700&amp;display=swap" rel="stylesheet">
  ...
  <header class="header header--default" data-sticky="true">
      ...
      <div class="header__right">
        ...
        <!--Logout Button--><div class="header__actions"><a href="user_orderhistory.php?userid=<?php echo $userid;?>">Order History</a><a href="user_customeredit.php?userid=<?php echo $userid;?>">Profile</a><a method = 'post' input type = 'submit ' value="logout" href="logout.php">  logout </a>
    ...
    <div id="homepage-2">
      <div class="ps-home-banner bg--cover" data-background="img/bg/home-2/home-banner.jpg">
        <h1><?php echo $user_data['fname']; echo ' ' ; echo $user_data['lname']; ?></h1>
...
.box input[type = "text"]:focus,.box input[type = "password"]:focus,.box input[type = "email"]:focus{
  ...
  border-color: #d9cd9c;
                ...
                $userid = $_SESSION['userid'];
                    $q="SELECT * FROM `address` WHERE userid = $userid" ;
					$result=$con->query($q);
					if(!$result){
                    ...
                    echo "<form action='updatecsad.php' method='post'>";
					...
					echo "<input class='ps-btn ps-product__add-to-cart' type='submit' name='subsa' value='edit address'>";			
