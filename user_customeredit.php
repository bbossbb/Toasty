...
<head>
    ...
    <title>Toasty | Profile</title><link href="https://fonts.googleapis.com/css?family=Cormorant+Garamond:300i,400,400i,500,500i,600,600i,700&amp;display=swap" rel="stylesheet">
  ...
  <header class="header header--default" data-sticky="true">
      ...
      <div class="header__right">
        ...
        <!--Logout Button--><div class="header__actions"><a href="user_addressedit.php?userid=<?=$userid?>"> Edit Address </a><a method = 'post' input type = 'submit ' value="logout" href="logout.php">  logout </a>
...
.box input[type = "text"]:focus,.box input[type = "password"]:focus,.box input[type = "email"]:focus{
  ...
  border-color: #d9cd9c;
                ...
                $userid = $_SESSION['userid'];
                    ...
                    echo "<form action='updatecs.php' method='post'>";
                    while($row=$result->fetch_array()){
                  
					
                    echo"<p for = 'username'> Username </p>";
                    echo "<br>";
					...
					echo "<input class='ps-btn ps-product__add-to-cart' type='submit' name='subs' value='edit profile'>";			
