...
<head>
    ...
    <title>Toasty | Staff Payment Status</title><link href="https://fonts.googleapis.com/css?family=Cormorant+Garamond:300i,400,400i,500,500i,600,600i,700&amp;display=swap" rel="stylesheet">
...
.box input[type = "text"]:focus,.box input[type = "password"]:focus{
  ...
  border-color: #d9cd9c;
                 ...
                 <?php 
                    ...
                    $q="SELECT * FROM `order`as o where paymentid = '$paymentid'" ;
					$result=$con->query($q);
					if(!$result){
                    ...
                    echo "<br>";
					echo "<input type='text' name='paymentstatus' value=".$row['paymentstatus'].">";
                    echo "<br>";
                    echo "<br>";
					...
					echo "<input class = 'ps-btn ps-product__add-to-cart' type='submit' name='submit2' value='submit'>";			
