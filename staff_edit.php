...
<head>
    ...
    <title>Toasty | Staff Edit</title><link href="https://fonts.googleapis.com/css?family=Cormorant+Garamond:300i,400,400i,500,500i,600,600i,700&amp;display=swap" rel="stylesheet">
...
.box input[type = "text"]:focus,.box input[type = "password"]:focus,.box input[type = "email"]:focus{
  ...
  border-color: #d9cd9c;
                 ...
                 <?php 
					...
					echo"<p>Firstname</p>";
                    echo "<br>";
					echo "<input type='text' name='staff_fname' value=".$row['staff_fname'].">";
                    echo "<br>";
                    echo "<br>";

                    echo"<p>Lastname</p>";
                    echo "<br>";
					echo "<input type='text' name='staff_lname' value=".$row['staff_lname'].">";
                    echo "<br>";
                    echo "<br>";

                    echo"<p>Rank</p>";
                    echo "<br>";
					echo "<input type='text' name='staff_rank' value=".$row['staff_rank'].">";
                    echo "<br>";
                    echo "<br>";

                    echo"<p>Staff password</p>";
                    echo "<br>";
					echo "<input type='password' name='staff_password' value=''>";
                    echo "<br>";
                    echo "<br>";

                    echo"<p>Staff salary</p>";
                    echo "<br>";
					...
					echo "<input class='ps-btn ps-product__add-to-cart' type='submit' name='subk' value='submit'>";			
