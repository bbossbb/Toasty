...
<head>
    ...
    <title>Toasty | Admin Edit Customer</title><link href="https://fonts.googleapis.com/css?family=Cormorant+Garamond:300i,400,400i,500,500i,600,600i,700&amp;display=swap" rel="stylesheet">
  ...
  <header class="header header--default" data-sticky="true">
    ...
    <div id="homepage-2">
      ...
      <div class="ps-section__header">
                 <h3> Edit Customer Address Information </h3>
                </div>
...
.box input[type = "text"]:focus,.box input[type = "password"]:focus,.box input[type = "email"]:focus{
  ...
  border-color: #d9cd9c;
                 ...
                 <?php 
                    ...
                    echo "<form action='updateadd_admin.php' method='post'>";
                    while($row=$result->fetch_array()){
                  
					
                    echo"<p>House No.</p>";
                    echo "<br>";
					echo "<input type='text' name='addresshouse' value=".$row['addresshouse'].">";
                    echo "<br>";
                    ...
                    echo "<input type='hidden' name='addressid' value=".$row['addressid']." >";
					echo "<div class='center'>";
					echo "<input class='ps-btn ps-product__add-to-cart' type='submit' name='subp' value='submit'>";			
