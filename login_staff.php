...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
   ...
   if(!empty($staff_username)&& !empty($staff_password))
   {
    // read from database

    $query = "SELECT * FROM staff WHERE staff_username = '$staff_username' limit 1";
      ...
      if($result && mysqli_num_rows($result)>0)
        {
            ...
            if($staff_data['staff_password'] == $staff_password1){
              $_SESSION['staffid'] = $staff_data['staffid']; 
...
<head>
    ...
    <title>Toasty | Staff Sign In</title>
