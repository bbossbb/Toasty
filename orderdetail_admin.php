...
<head>
    ...
    <title>Toasty | Order Details</title><link href="https://fonts.googleapis.com/css?family=Cormorant+Garamond:300i,400,400i,500,500i,600,600i,700&amp;display=swap" rel="stylesheet">
  ...
  <header class="header header--default" data-sticky="true">
    ...
    ?>
                ...
                <td><a href='order_detail_look.php?orderid=<?=$rows['orderid']?>'><img src="img/detail_admin.png" width="24" height="24"></a></td>
