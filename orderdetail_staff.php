...
<head>
  ...
  <header class="header header--default" data-sticky="true">
    ...
    <?php 
				 	...
				 	$q= "SELECT * FROM `order` ORDER BY ordertime DESC";
					$result=$con->query($q);
					if(!$result){
    ...
    ?>
                ...
                <td><a href='order_detail_look_staff.php?orderid=<?=$rows['orderid']?>'><img src="img/detail_admin.png" width="24" height="24"></a></td>
