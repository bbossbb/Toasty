...
$staff_data = check_login_admin($con);
...
<head>
    ...
    <title>Toasty | Admin Edit Stock</title><link href="https://fonts.googleapis.com/css?family=Cormorant+Garamond:300i,400,400i,500,500i,600,600i,700&amp;display=swap" rel="stylesheet">
...
.box input[type = "text"]:focus,.box input[type = "password"]:focus,.box input[type = "email"]:focus{
  ...
  border-color: #d9cd9c;
                 ...
                 <?php 
                    ...
                    echo "<form action='updatestock_admin.php' method='post'>";
                ...
                ?> 	 
                <div class ="box" >
                  <input type='text' name='pquantity' value=<?php	echo $row['pquantity'];?>>
                  </div>
                   <?php
                    ...
                    echo "<input class = 'btn' type='hidden' name='productid' value=".$row['productid']." >";
